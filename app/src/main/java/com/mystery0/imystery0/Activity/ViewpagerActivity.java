...
import com.mystery0.imystery0.BaseClass.DepthPageTransformer;
...
public class ViewpagerActivity extends Activity
{
    ...
    public void Set_Res()
    {
        ...
        for (int i = 0; i < 3; i++)
        {
            ...
            v.setBackgroundResource(R.drawable.ic_point_white);
            //指定其大小
    ...
    public void initEvent()
    {
        ...
        mView.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener()
        {
            ...
            {
                distance = mLinearLayout.getChildAt(1).getLeft() - mLinearLayout.getChildAt(0).getLeft();
            }
        });
