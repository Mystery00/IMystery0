package com.mystery0.imystery0.Setting.ThemeSetting;
 ...
 * 主题设置
 */
public class ThemeSetting extends Activity implements View.OnClickListener
{
    ...
    public void onClick(View view)
    {
        ...
        switch (view.getId())
        {
            case R.id.back_theme:
                startActivity(new Intent(ThemeSetting.this, Setting_Activity.class));
                finish();
                break;
